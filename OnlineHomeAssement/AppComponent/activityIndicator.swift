...
public class activityIndicator: UIView, CAAnimationDelegate {
    ...
    @IBInspectable public var strokeColor: UIColor = UIColor.white//UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0)
        {
        didSet{
    ...
    private func setProgressLayerPath() {
        ...
        let path = UIBezierPath(arcCenter: center, radius: radius, startAngle: CGFloat(0.0), endAngle: CGFloat(2 * CGFloat.pi), clockwise: true)
